...
[x,fe]=audioread("C:\Users\Desktop\MyFile\S'5\Traitement de signal\tp2\Phrase.m4a");
...
stem(x)
%Apres le tracage de la fonction x on peut arriver a voir que le morceau 
%Rien ne sert de est contenue dans la partie de l'index 1025  2.05e05
...
% Synthese et analyse spectrale d�une gamme de musique
