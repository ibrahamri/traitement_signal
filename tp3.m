...
% représentation graphique du signal ECG dans le domaine frequentielle
f=(0:N-1)*(Fe/N);
fshift=(-N/2:N/2-1)*(Fe/N);
y = fft(ecg);
plot(f,abs(y))
grid on
title(" représentation graphique du signal ECG dans le domaine frq")
xlabel("f")
ylabel("fft()")

% subplot(3,2,2)
% représentation graphique de la transformée de fourier du signal ECG
...
%filtre 1
%filter passe haut pour les haut frq
